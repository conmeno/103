...
-(void)loadData
{
    ...
    ViewController *rootViewController = (ViewController *)navController.viewControllers[0];
    ...
    NSString *stringFromFileAtURL = [[NSString alloc]
                                     ...
                                     error:&error];
    	rootViewController.allLines = [stringFromFileAtURL componentsSeparatedByString: @"\n"];
}
